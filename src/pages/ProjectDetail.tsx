    ...
    <div>
      ...
      <main className="mx-auto max-w-6xl px-5 py-12 sm:py-16">
        ...
        <section className="mt-8 grid items-start gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div
            className="soft-panel relative min-h-80 overflow-hidden rounded-3xl p-6 sm:min-h-96"
            ...
            {project.image ? (
              ...
              <>
                <div
                  ...
                  style={{
                    background:
                      'radial-gradient(circle at 80% 15%, rgba(var(--glow-rgb), 0.38), transparent 15rem)',
                  }}
                />
